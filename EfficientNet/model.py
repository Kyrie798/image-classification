...
class ConvBNAct(nn.Module):
    def __init__(self, in_planes, out_planes, kernel_size=3, stride=1, groups=1, norm_layer=nn.BatchNorm2d, activation_layer=nn.SiLU):
        super().__init__()
...
class MBConv(nn.Module):
    def __init__(self, kernel_size, input_c, out_c, expand_ratio, stride, se_ratio, drop_rate, norm_layer):
        super().__init__()
...
class EfficientNetV2(nn.Module):
    def __init__(self, model_cnf, num_classes=1000, num_features=1280, dropout_rate=0.2, drop_connect_rate=0.2):
        super().__init__()
...
def efficientnetv2_s(num_classes: int = 1000):
    ...
    model = EfficientNetV2(model_cnf=model_config, num_classes=num_classes, dropout_rate=0.2)
    return model
...
def efficientnetv2_m(num_classes: int = 1000):
    ...
    model = EfficientNetV2(model_cnf=model_config, num_classes=num_classes, dropout_rate=0.3)
    return model
...
def efficientnetv2_l(num_classes: int = 1000):
    ...
    model = EfficientNetV2(model_cnf=model_config, num_classes=num_classes, dropout_rate=0.4)
    return model
